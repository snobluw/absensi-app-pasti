...
<div class="position-relative">
    <div class="card shadow-sm d-flex col-12 col-md-12 col-lg-8 mx-auto mt-4">
        ...
        <div class="card-body">
            <form action="/admin/{{ $admin->id }}" method="POST" id="admin-form">
                @method('PUT')
                @csrf
                ...
                <div class="mb-3 col-6">
                    ...
                    <select class="form-select" name="gender" id="gender" required>
                        <option value="L" {{ $admin->user->gender === 'L' ? 'selected' : '' }}>Laki-laki</option>
                        <option value="P" {{ $admin->user->gender === 'P' ? 'selected' : '' }}>Perempuan</option>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username"
                        name="username" maxlength="20" value="{{ old ('username',$admin->user->username) }}">
...
<script>
    ...
    let oldUsername = "{{ $admin->user->username }}";
